    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i> Edit Data Pegawai</h2>
            ...
            <div class="box-content">
                <div class="card">
                  <div class="card-body">
                    <form method="post" action="<?php echo base_url('DataPegawai/updateDataPegawai/'.$detail->nip)?>">
                     <div class="form-group">
                      <label>NIP</label>
                      <input type="text" name="nip" class="form-control" value="<?php echo $detail->nip ?>" required >
                     </div>
                     <div class="form-group">
                      <label>Nama</label>
                      <input type="text" name="namap" class="form-control" value="<?php echo $detail->nama_pegawai ?>" required>
                     </div>
                     <div class="form-group">
                      <label>Alamat</label>
                      <textarea class="form-control" name="alamat" value="<?php echo $detail->alamat ?>"><?php echo $detail->alamat ?></textarea>
                     </div>
                     <div class="form-group">
                      <label>Nomor Telepon</label>
                      <input type="text" name="telp" class="form-control" value="<?php echo $detail->nomor_telepon ?>" required>
                     </div>
