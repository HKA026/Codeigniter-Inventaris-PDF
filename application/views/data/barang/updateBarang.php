    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i> Edit Data Barang</h2>
            ...
            <div class="box-content">
                <div class="card">
                  <div class="card-body">
                    <form method="post" action="<?php echo base_url('DataBarang/updateDataBarang/'.$detail->kode_barang)?>">
                     <div class="form-group">
                      <label>Kode Barang</label>
                      <input type="text" name="kode_barang" class="form-control" value="<?php echo $detail->kode_barang ?>" required >
                     </div>
                     <div class="form-group">
                      <label>Nama Barang</label>
                      <input type="text" name="nama_barang" class="form-control" value="<?php echo $detail->nama_barang ?>" required>
                     </div>
                     <div class="form-group">
                      <label>Kondisi Barang</label>
                      <input type="text" name="kndisi_bar" class="form-control" value="<?php echo $detail->kondisi_barang ?>" required>
                     </div>
                     <div class="form-group">
                      <label> jenis</label>
                      <input type="text" name="id_jenis" class="form-control" value="<?php echo $detail->id_jenis ?>" required>
                     </div><div class="form-group">
                      <label>jumlah</label>
                      <input type="text" name="jumlah" class="form-control" value="<?php echo $detail->jumlah ?>" required>
                     </div><div class="form-group">
                      <div class="form-group">
