    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i> Edit Data Petugas</h2>
            ...
            <div class="box-content">
                <div class="card">
                  <div class="card-body">
                    <form method="post" action="<?php echo base_url('DataPetugas/updateDataPetugas/'.$detail->id_petugas)?>">
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" name="username" class="form-control" value="<?php echo $detail->username ?>" required>
                     </div>
                     <div class="form-group">
                      <label>Password</label>
                      <input type="text"class="form-control" name="password" value="<?php echo $detail->password ?>"></div>
                     </div>
                     <div class="form-group">
                      <label>Nama Petugas</label>
                      <input type="text" name="nama_petugas" class="form-control" value="<?php echo $detail->nama_petugas ?>" required>
                     </div><div class="form-group">
                      <label>Level</label>
                      <input type="text" name="level" class="form-control" value="<?php echo $detail->level ?>" required>
                     </div>
                     <div class="form-group">
                      <label>Status</label>
                      <input type="text" name="status" class="form-control" value="<?php echo $detail->status ?>" required>
                     </div>
