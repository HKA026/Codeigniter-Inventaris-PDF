...
<body>
    ...
    <pre style="float: left;">DATA LAPORAN PENGEMBALIAN</pre>
    ...
    <div class="row">
                ...
                <table>
                    ...
                    <?php for($i=0; $i<sizeof($object->kode_kembali); $i++):?>
                    <tr>
                        <td style="text-align: center;"><?php echo $i+1;?></td>
                        <td style="text-align: center;"><?php echo $object->kode_kembali[$i];?></td>
                        <td style="text-align: center;"><?php echo $object->tanggal_kembali[$i];?></td>
                        ...
                        <td style="text-align: center;"><?php echo $object->jumlah_kembali[$i];?></td>
                    </tr>
                    <?php endfor;?>
                </table><br><br>
                <pre>
